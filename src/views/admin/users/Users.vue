...
<template>
    <div class="max-w-6xl mx-auto p-6 space-y-10 bg-white">
        ...
        <div class="card flex justify-center">
            <Button label="Crear Usuario" @click="visible = true" />
                ...
                <Column :exportable="false" style="min-width: 12rem" header="Acciones">
                    <template #body="slotProps">
                        <Button icon="pi pi-pencil" variant="outlined" rounded class="mr-2"
                            @click="funEditarUser(slotProps.data)" />
                        <Button icon="pi pi-trash" variant="outlined" rounded severity="danger"
                            @click="funEliminarUser(slotProps.data)" />
                    </template>
                </Column>
            </DataTable>
        </div>
